...
# 10. Monitoring Stack - DOPRACOWANE
...
# 11. Terraform
print_step "Tworzenie konfiguracji Terraform..."
...
git init
git add .
git commit -m "Initial commit: Davtro Website with full DevOps stack"
...
echo "5. Skonfiguruj secret GHCR: ./setup-ghcr-secret.sh <username> <token>"
echo ""
